...
public class MainController {
    ...
    @FXML protected void handleCountButtonAction(ActionEvent event) {
        ...
        magicString.append("Остаток: " + problem.left(ans) +"\n");
        ...
        magicString.append("Ответ: " + ans.get(initNV - 1)+"\n");
        magicString.append("Остаток: " + lucky.left(ans) +"\n");
        ...
        magicString.append("Ответ: " + ans.get(initNV - 1)+"\n");
        magicString.append("Остаток: " + unlucky.left(ans) +"\n");
